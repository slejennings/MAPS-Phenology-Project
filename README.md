...
**Note:** files with * at end of name are too large to sync with the GitHub repository and need to be downloaded from the accompanying FigShare folder
...
**Note:** all files within these folders are too large to sync with the GitHub repository and need to be downloaded from the accompanying FigShare folder
...
**Note:** all files within this folders are too large to sync with the GitHub repository and need to be downloaded from the accompanying FigShare folder
...
**Note:** files with * at end of their name are too large to sync with the GitHub repository and need to be downloaded from the accompanying FigShare folder
